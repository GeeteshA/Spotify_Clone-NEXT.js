...
const Song = ({ sno, track, setGlobalTrackId, setGlobalIsPlaying, setView, setGlobalArtistId }) => {
    ...
    return (
        <div onClick={() => playSong(track.track.id, track.track.uri)} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} 
                className="grid grid-cols-2 text-gray-400 text-sm py-4 px-5 hover:bg-gray-900 
